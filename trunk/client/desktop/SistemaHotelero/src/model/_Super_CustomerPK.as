 ...
 * of this value object you may modify the generated sub-class of this class - CustomerPK.as.
 */
...
[ExcludeClass]
public class _Super_CustomerPK extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("com.cdz.sh.model.CustomerPK") == null)
            {
                flash.net.registerClassAlias("com.cdz.sh.model.CustomerPK", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _CustomerPKEntityMetadata;
     ...
     * properties
     */
    private var _internal_docType : model.DocumentType;
    private var _internal_idNumber : String;
    ...
    public function _Super_CustomerPK()
    {
    ...
    public function get docType() : model.DocumentType
    {
    ...
    public function set docType(value:model.DocumentType) : void
    {
        var oldValue:model.DocumentType = _internal_docType;
        if (oldValue !== value)
        {
    ...
    {
        var oldValue:String = _internal_idNumber;
        if (oldValue !== value)
        {
            _internal_idNumber = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "idNumber", oldValue, _internal_idNumber));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CustomerPKEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CustomerPKEntityMetadata) : void
    {
        var oldValue : _CustomerPKEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
