...
/**
 * Room 1 empty but it does not have the needed quantity of days
 ...
 *
 */
public class ScenarioBuilder_LessDaysThanExpected_SameRoomType {
	...
	public ScenarioBuilder_LessDaysThanExpected_SameRoomType() throws DaoException {
	...
	private void fillOccupationsForAllRooms() throws DaoException {
		...
		//for the second room, about the half
		roomId++;
